...
Веб-приложение для работы с материалами модулей 01–04:
- 📖 Рендер README как страниц с подсветкой синтаксиса
- ▶ Monaco-редактор с кодом примеров
- 🔧 JS: выполнение в sandbox (консоль вывода)
- 🌐 HTML/CSS: live Preview в iframe
