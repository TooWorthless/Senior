...
export default function AppSidebar({ modules }: Props) {
  const pathname =
    useSearchParams === undefined ? "/" : (usePathname() as string);
          ...
          <div key={mod.id}>
            ...
            {isExpanded &&
              mod.submodules.map((sub) => {
                const isSubActive =
                  isModActive && currentSub === sub.id && !currentFile;
                    ...
                    {isSubExpanded &&
                      sub.examples.map((ex) => {
                        ...
                        return (
                          ...
                          >
                            <span className={`ext-badge ${ex.extension}`}>
                              {ex.extension}
                            </span>
                            {ex.label}
                          </Link>
